@extends('layouts.app')
@section('title',__('edit_vehicule'))
    ...
    <div class="card-wrapper">
      ...
      <div class="card ">
        ...
        <div class="card-body">
          ...
          <form class="needs-validation" novalidate="" action="{{route('vehicule.update',$vehicule->id)}}" method="POST"> 
                @csrf
                @method('PATCH') 
                <div class="form-group row">
                    <label for="nom" class="col-md-2 col-form-label form-control-label">Nom de vehicule</label>
                    <div class="col-md-10">
                    <input type="text" class="form-control" value="{{$vehicule->nom}}" id="nom"  name="nom" required="">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control" id="modele_id" name="modele_id">
                            <option value="{{$vehicule->modele_id}}">{{$vehicule->modele['nom']}}</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control" id="marque_id" name="marque_id">
                            <option value="{{$vehicule->marque_id}}">{{$vehicule->marque['nom']}}</option>
